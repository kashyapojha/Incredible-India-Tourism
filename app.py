...
QUIZ_QUESTIONS = [
    ...
    {"q": "Ghost Pepper (Bhut Jolokia) grows in which state?", "options": ["Andhra Pradesh", "Karnataka", "Nagaland", "Rajasthan"], "ans": "Nagaland"},
...
def home():
    ...
    states_list = [{"key": k, **{f: v for f, v in v.items()}} for k, v in STATES.items()]
